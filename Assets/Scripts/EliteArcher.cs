...
public class EliteArcher : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Shooted == true)
        {
            if (rabaAnim.GetCurrentAnimatorStateInfo(0).IsName("ATTACK") && rabaAnim.GetCurrentAnimatorStateInfo(0).normalizedTime > 0.575f)
            {
                ...
                CarrotController.InsCarrot(SpawnPos, TargetVecList, SpawnArea , new Vector3(2f, 2f, 0.8f));
        ...
        if (PAshooted == true)
        {
            if (rabaAnim.GetCurrentAnimatorStateInfo(0).IsName("POWERATTACK") && rabaAnim.GetCurrentAnimatorStateInfo(0).normalizedTime > 0.575f)
            {
                ...
                CarrotController.InsCarrot(SpawnPos, TargetVecList, SpawnArea, new Vector3(4f, 4f, 1.5f));
                PAshooted = false;
            }
        }
    }
