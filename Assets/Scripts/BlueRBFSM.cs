...
public class BlueRBFSM : MonoBehaviour
{
    //檢查狀態的delegate
    ...
    void Update()
    {
        ...
        if (Shooted == true)
        {
            if (rabaAnim.GetCurrentAnimatorStateInfo(0).IsName("ATTACK") && rabaAnim.GetCurrentAnimatorStateInfo(0).normalizedTime > 0.35f)
            {
                ...
                CarrotController.InsCarrot(SpawnPos, TargetVecList, "A", new Vector3(0.5f, 0.5f, 0.5f) , "Weapons/carrotarrow_Variant_1");
                Shooted = false;
            }
        }
        if (PAshooted == true)
        {
            if (rabaAnim.GetCurrentAnimatorStateInfo(0).IsName("POWERATTACK") && rabaAnim.GetCurrentAnimatorStateInfo(0).normalizedTime > 0.575f)
            {
                ...
                CarrotController.InsCarrot(SpawnPos, TargetVecList, "B", new Vector3(0.5f, 0.5f, 0.5f) , "Weapons/carrotarrow_Variant_1");
